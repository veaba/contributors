...
# esbuild .ts => .js
# node run.app  = >
#   1. get repos github api
#   2. avatar link save to local
#   3. API to svg 
#   4. add svg data to veaba/contributors branch
#   5. build vue project to git-pages branch and publish
#   6. generate data merge to main branch
#   7. done
# 检查Actions目录配置
